...
from gmail_tui.utils import create_folder, get_imap_connection


class MkdirCommand(Command):
    """Command for creating email folders."""
    ...
    def add_parser(self, subparsers: argparse._SubParsersAction) -> None:
        ...
        parser.add_argument("folder", help="Folder name to create")
    ...
    def handle(self, args: argparse.Namespace) -> None:
        ...
        try:
            with get_imap_connection(
                ...
                if not create_folder(client, args.folder):
                    sys.stderr.write("Error: Failed to create folder\n")
                    sys.exit(1)
